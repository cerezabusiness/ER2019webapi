...
class MultimediaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create multimedium" do
    assert_difference('Multimedium.count') do
      post multimedia_url, params: { multimedium: { event_id: @multimedium.event_id, multimedia_type_id: @multimedium.multimedia_type_id, name: @multimedium.name, url: @multimedium.url } }
    end
  ...
  test "should update multimedium" do
    patch multimedium_url(@multimedium), params: { multimedium: { event_id: @multimedium.event_id, multimedia_type_id: @multimedium.multimedia_type_id, name: @multimedium.name, url: @multimedium.url } }
